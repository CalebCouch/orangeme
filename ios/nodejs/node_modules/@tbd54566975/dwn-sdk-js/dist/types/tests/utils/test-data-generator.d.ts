...
export declare class TestDataGenerator {
    ...
    static generateEventsQuery(input: GenerateEventsQueryInput): Promise<GenerateEventsQueryOutput>;
    /**
     * Generates a EventsSubscribe message for testing.
     */
    static generateEventsSubscribe(input?: GenerateEventsSubscribeInput): Promise<GenerateEventsSubscribeOutput>;

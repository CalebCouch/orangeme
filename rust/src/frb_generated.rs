...
fn wire__crate__api__pub_structs__load_structs_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api__t = <crate::api::pub_structs::Thread>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::pub_structs::load_structs(
                            api__s, api__p, api__dm, api__kp, api__pl, api__pn, api__wm, api__t,
                        );
                    })?;
                    Ok(output_ok)
                })())
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            ...
            2 => {
                ...
                return crate::api::pub_structs::WalletMethod::BuildTransaction(
...
impl flutter_rust_bridge::IntoDart for crate::api::pub_structs::WalletMethod {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            .into_dart(),
            crate::api::pub_structs::WalletMethod::BuildTransaction(
                field0,
                field1,
                field2,
                field3,

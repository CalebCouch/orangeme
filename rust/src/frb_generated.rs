    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::pub_structs::load_structs(api__s, api__p);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__simple__rustStart_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            let api_thread = decode_DartFn_Inputs_dart_command_Output_String_AnyhowException(
...
fn wire__crate__api__utils__updateDisplayAmount_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            let api_input = <crate::api::pub_structs::KeyPress>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::api::utils::updateDisplayAmount(
                            api_amount,
                            api_balance,
                            api_price,
                            api_input,
...
fn decode_DartFn_Inputs_dart_command_Output_String_AnyhowException(
    ...
    async fn body(
        dart_opaque: flutter_rust_bridge::DartOpaque,
        arg0: crate::api::pub_structs::DartCommand,
    ) -> String {
...
impl SseDecode for crate::api::pub_structs::DartCommand {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return crate::api::pub_structs::DartCommand {
            method: var_method,
            data: var_data,
        };
    }
...
impl SseDecode for crate::api::pub_structs::Thread {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            0 => {
                let mut var_field0 =
                    <crate::api::pub_structs::WalletMethod>::sse_decode(deserializer);
...
impl SseDecode for crate::api::pub_structs::WalletMethod {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            0 => {
                return crate::api::pub_structs::WalletMethod::GetNewAddress;
            }
            1 => {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::pub_structs::DartCommand
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::DartCommand>
    for crate::api::pub_structs::DartCommand
{
...
impl flutter_rust_bridge::IntoDart for crate::api::pub_structs::Thread {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            crate::api::pub_structs::Thread::Wallet(field0) => {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::pub_structs::Thread
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::Thread>
    for crate::api::pub_structs::Thread
{
...
impl flutter_rust_bridge::IntoDart for crate::api::pub_structs::WalletMethod {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            crate::api::pub_structs::WalletMethod::GetNewAddress => [0.into_dart()].into_dart(),
            crate::api::pub_structs::WalletMethod::GetFees(field0, field1) => [
                1.into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::pub_structs::WalletMethod
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::WalletMethod>
    for crate::api::pub_structs::WalletMethod
{
...
impl SseEncode for crate::api::pub_structs::Thread {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::api::pub_structs::Thread::Wallet(field0) => {
                <i32>::sse_encode(0, serializer);
                <crate::api::pub_structs::WalletMethod>::sse_encode(field0, serializer);
            }
            _ => {
                unimplemented!("");
            }
...
impl SseEncode for crate::api::pub_structs::WalletMethod {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::api::pub_structs::WalletMethod::GetNewAddress => {
                <i32>::sse_encode(0, serializer);
            }
            crate::api::pub_structs::WalletMethod::GetFees(field0, field1) => {
                <i32>::sse_encode(1, serializer);

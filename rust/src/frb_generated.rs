...
return crate::api::pub_structs::ShorthandTransaction{is_withdraw: var_isWithdraw, date: var_date, time: var_time, amount: var_amount, txid: var_txid};}
                }
...
crate::api::pub_structs::PageName::Test(field0) => { [2.into_dart(),
...
crate::api::pub_structs::PageName::Test(field0) => { <i32>::sse_encode(2, serializer); <String>::sse_encode(field0, serializer);
 }
 _ => { unimplemented!(""); }}}
                }

...
flutter_rust_bridge::frb_generated_boilerplate!(
                ...
                pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1045459407;
...
let api_page = <crate::api::pub_structs::PageName>::sse_decode(&mut deserializer);deserializer.end(); move |context| async move {
            ...
            }fn wire__crate__api__pub_structs__platform_default_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "platform_default", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            deserializer.end(); move |context|  {
                    transform_result_sse::<_, ()>((move ||  {
                         let output_ok = Result::<_,()>::Ok(crate::api::pub_structs::Platform::default())?;   Ok(output_ok)
                    })())
                } })
...
let api_thread = decode_DartFn_Inputs_String_Output_String_AnyhowException(<flutter_rust_bridge::DartOpaque>::sse_decode(&mut deserializer));deserializer.end(); move |context| async move {
            ...
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_path = <String>::sse_decode(&mut deserializer);
let api_field = <crate::api::pub_structs::Field>::sse_decode(&mut deserializer);deserializer.end(); move |context| async move {
                    transform_result_sse::<_, ()>((move || async move {
                         let output_ok = Result::<_,()>::Ok(crate::api::simple::setstate(api_path, api_field).await)?;   Ok(output_ok)
                    })().await)
                } })
            }
...
// Section: dart2rust
        ...
        return String::from_utf8(inner).unwrap();}
            ...
            match tag_ {0 => { let mut var_field0 = <Option<String>>::sse_decode(deserializer);
return crate::api::pub_structs::Field::Path(var_field0); }
1 => { let mut var_field0 = <Option<f64>>::sse_decode(deserializer);
return crate::api::pub_structs::Field::Price(var_field0); }
2 => { let mut var_field0 = <Option<bool>>::sse_decode(deserializer);
return crate::api::pub_structs::Field::Internet(var_field0); }
3 => { let mut var_field0 = <Option<crate::api::pub_structs::Platform>>::sse_decode(deserializer);
return crate::api::pub_structs::Field::Platform(var_field0); }
 _ => { unimplemented!(""); }}}
                }
        ...
        return ans_;}
                ...
                impl SseDecode for Option<crate::api::pub_structs::Platform> {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {if (<bool>::sse_decode(deserializer)) {
                return Some(<crate::api::pub_structs::Platform>::sse_decode(deserializer));
            } else {
                return None;
            }}
                }
        ...
        return match inner {
            0 => crate::api::pub_structs::PageName::Test,
...
8 => wire__crate__api__pub_structs__field_into_bytes_impl(port, ptr, rust_vec_len, data_len),
9 => wire__crate__api__simple__getpage_impl(port, ptr, rust_vec_len, data_len),
10 => wire__crate__api__pub_structs__platform_default_impl(port, ptr, rust_vec_len, data_len),
12 => wire__crate__api__simple__ruststart_impl(port, ptr, rust_vec_len, data_len),
13 => wire__crate__api__simple__setstate_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
                }
...
// Section: rust2dart
            ...
            impl flutter_rust_bridge::IntoDart for crate::api::pub_structs::Field {
                fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
                    match self {crate::api::pub_structs::Field::Path(field0) => { [0.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::Field::Price(field0) => { [1.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::Field::Internet(field0) => { [2.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::Field::Platform(field0) => { [3.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
 _ => { unimplemented!(""); }}
                }
            }
...
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::Platform> for crate::api::pub_structs::Platform {
            fn into_into_dart(self) -> crate::api::pub_structs::Platform {
                ...
                impl SseEncode for crate::api::pub_structs::Field {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {match self {crate::api::pub_structs::Field::Path(field0) => { <i32>::sse_encode(0, serializer); <Option<String>>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::Field::Price(field0) => { <i32>::sse_encode(1, serializer); <Option<f64>>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::Field::Internet(field0) => { <i32>::sse_encode(2, serializer); <Option<bool>>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::Field::Platform(field0) => { <i32>::sse_encode(3, serializer); <Option<crate::api::pub_structs::Platform>>::sse_encode(field0, serializer);
 }
 _ => { unimplemented!(""); }}}
                }
        ...
        for item in self { <u8>::sse_encode(item, serializer); }}
                ...
                impl SseEncode for Option<crate::api::pub_structs::Platform> {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<bool>::sse_encode(self.is_some(), serializer);
                if let Some(value) = self {
                    <crate::api::pub_structs::Platform>::sse_encode(value, serializer);
                }}
                }
                
                impl SseEncode for crate::api::pub_structs::PageName {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<i32>::sse_encode(match self {crate::api::pub_structs::PageName::Test => { 0 }

...
let api_data = <String>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
            ...
            }fn wire__crate__api__simple__clearData_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "clearData", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_path = <String>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, ()>((move ||  {
                         let output_ok = Result::<_,()>::Ok({ crate::api::simple::clearData(api_path); })?;   Ok(output_ok)
                    })())
                } })
...
let api_page = <crate::api::pub_structs::PageName>::sse_decode(&mut deserializer);deserializer.end(); move |context| async move {
                    transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>((move || async move {
                         let output_ok = crate::api::simple::getPage(api_path, api_page).await?;   Ok(output_ok)
                    })().await)
                } })
            }fn wire__crate__api__pub_structs__load_structs_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "load_structs", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api__s = <crate::api::pub_structs::ShorthandTransaction>::sse_decode(&mut deserializer);
...
let api__wm = <WalletMethod>::sse_decode(&mut deserializer);
let api__t = <Thread>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, ()>((move ||  {
                         let output_ok = Result::<_,()>::Ok({ crate::api::pub_structs::load_structs(api__s, api__p, api__dm, api__kp, api__pl, api__pn, api__wm, api__t); })?;   Ok(output_ok)
                    })())
                } })
            }fn wire__crate__api__pub_structs__platform_is_desktop_impl(ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "platform_is_desktop", port: None, mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <crate::api::pub_structs::Platform>::sse_decode(&mut deserializer);deserializer.end();
                transform_result_sse::<_, ()>((move || {
                     let output_ok = Result::<_,()>::Ok(crate::api::pub_structs::Platform::is_desktop(&api_that))?;   Ok(output_ok)
                })()) })
            }fn wire__crate__api__simple__rustCall_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec,_,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "rustCall", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_thread = <Thread>::sse_decode(&mut deserializer);deserializer.end(); move |context| async move {
                    transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>((move || async move {
                         let output_ok = crate::api::simple::rustCall(api_thread).await?;   Ok(output_ok)
                    })().await)
                } })
...
let api_callback = decode_DartFn_Inputs_dart_method_Output_opt_String_AnyhowException(<flutter_rust_bridge::DartOpaque>::sse_decode(&mut deserializer));deserializer.end(); move |context| async move {
                    transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>((move || async move {
                         let output_ok = crate::api::simple::rustStart(api_path, api_platform, api_callback).await?;   Ok(output_ok)
                    })().await)
                } })
            }
...
fn decode_DartFn_Inputs_dart_method_Output_opt_String_AnyhowException(
                    ...
                    async fn body(dart_opaque: flutter_rust_bridge::DartOpaque, arg0: crate::api::pub_structs::DartMethod) -> Option<String> {
...
flutter_rust_bridge::frb_generated_moi_arc_impl_value!(flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>);
flutter_rust_bridge::frb_generated_moi_arc_impl_value!(flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>);
...
// Section: dart2rust
        ...
        return flutter_rust_bridge::for_generated::rust_auto_opaque_decode_owned(inner);}
                ...
                impl SseDecode for Thread {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut inner = <RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>>>::sse_decode(deserializer);
        return flutter_rust_bridge::for_generated::rust_auto_opaque_decode_owned(inner);}
                }
                
                impl SseDecode for WalletMethod {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut inner = <RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>>>::sse_decode(deserializer);
        return flutter_rust_bridge::for_generated::rust_auto_opaque_decode_owned(inner);}
                }
        ...
        return decode_rust_opaque_moi(inner);}
                ...
                impl SseDecode for RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>> {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut inner = <usize>::sse_decode(deserializer);
        return decode_rust_opaque_moi(inner);}
                }
                
                impl SseDecode for RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>> {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut inner = <usize>::sse_decode(deserializer);
        return decode_rust_opaque_moi(inner);}
                }
...
12 => crate::api::pub_structs::KeyPress::Backspace,
        ...
        return ans_;}
                ...
                impl SseDecode for Option<crate::api::pub_structs::KeyPress> {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {if (<bool>::sse_decode(deserializer)) {
                return Some(<crate::api::pub_structs::KeyPress>::sse_decode(deserializer));
            } else {
                return None;
            }}
                }
                ...
                impl SseDecode for crate::api::pub_structs::PageName {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut tag_ = <i32>::sse_decode(deserializer);
            match tag_ {0 => { return crate::api::pub_structs::PageName::BitcoinHome; }
1 => { let mut var_field0 = <String>::sse_decode(deserializer);
return crate::api::pub_structs::PageName::ViewTransaction(var_field0); }
2 => { return crate::api::pub_structs::PageName::Receive; }
...
let mut var_field1 = <Option<crate::api::pub_structs::KeyPress>>::sse_decode(deserializer);
return crate::api::pub_structs::PageName::Amount(var_field0, var_field1); }
5 => { let mut var_field0 = <u64>::sse_decode(deserializer);
...
return crate::api::pub_structs::PageName::Confirm(var_field0, var_field1, var_field2); }
...
return crate::api::pub_structs::Profile{name: var_name, did: var_did, pfp_path: var_pfpPath, abt_me: var_abtMe};}
                }
                
                impl SseDecode for crate::api::pub_structs::ShorthandTransaction {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut var_isWithdraw = <bool>::sse_decode(deserializer);
let mut var_datetime = <String>::sse_decode(deserializer);
let mut var_amount = <String>::sse_decode(deserializer);
let mut var_txid = <String>::sse_decode(deserializer);
return crate::api::pub_structs::ShorthandTransaction{is_withdraw: var_isWithdraw, datetime: var_datetime, amount: var_amount, txid: var_txid};}
                }
...
// Section: rust2dart
            ...
            fn into_into_dart(self) -> FrbWrapper<MyCustomAsyncRuntime> {
                ...
                // Codec=Dco (DartCObject based), see doc to use other codecs
            impl flutter_rust_bridge::IntoDart for FrbWrapper<Thread> {
                fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
                    flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(self.0).into_dart()
                }
            }
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for FrbWrapper<Thread> {}

                impl flutter_rust_bridge::IntoIntoDart<FrbWrapper<Thread>> for Thread {
            fn into_into_dart(self) -> FrbWrapper<Thread> {
                self.into()
            }
        }
                ...
                // Codec=Dco (DartCObject based), see doc to use other codecs
            impl flutter_rust_bridge::IntoDart for FrbWrapper<WalletMethod> {
                fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
                    flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(self.0).into_dart()
                }
            }
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for FrbWrapper<WalletMethod> {}

                impl flutter_rust_bridge::IntoIntoDart<FrbWrapper<WalletMethod>> for WalletMethod {
            fn into_into_dart(self) -> FrbWrapper<WalletMethod> {
                self.into()
            }
        }
            ...
            impl flutter_rust_bridge::IntoDart for crate::api::pub_structs::DartMethod {
                fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
                    match self {crate::api::pub_structs::DartMethod::StorageSet(field0,field1) => { [0.into_dart(),
field0.into_into_dart().into_dart(),
field1.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::DartMethod::StorageGet(field0) => { [1.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
 _ => { unimplemented!(""); }}
                }
            }
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::pub_structs::DartMethod {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::DartMethod> for crate::api::pub_structs::DartMethod {
...
Self::Backspace => 12.into_dart(),
            ...
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::pub_structs::KeyPress {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::KeyPress> for crate::api::pub_structs::KeyPress {
...
// Codec=Dco (DartCObject based), see doc to use other codecs
            impl flutter_rust_bridge::IntoDart for crate::api::pub_structs::PageName {
                fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
                    match self {crate::api::pub_structs::PageName::BitcoinHome => { [0.into_dart()].into_dart() }
crate::api::pub_structs::PageName::ViewTransaction(field0) => { [1.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Receive => { [2.into_dart()].into_dart() }
crate::api::pub_structs::PageName::Send(field0) => { [3.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Amount(field0,field1) => { [4.into_dart(),
field0.into_into_dart().into_dart(),
field1.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Speed(field0) => { [5.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Confirm(field0,field1,field2) => { [6.into_dart(),
field0.into_into_dart().into_dart(),
field1.into_into_dart().into_dart(),
field2.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Success(field0) => { [7.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Test(field0) => { [8.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
 _ => { unimplemented!(""); }}
                }
            }
...
Self::Fuchsia => 5.into_dart(),
            ...
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::pub_structs::Platform {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::Platform> for crate::api::pub_structs::Platform {
...
self.abt_me.into_into_dart().into_dart()
            ...
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::pub_structs::Profile {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::Profile> for crate::api::pub_structs::Profile {
...
self.txid.into_into_dart().into_dart()
            ...
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::pub_structs::ShorthandTransaction {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::ShorthandTransaction> for crate::api::pub_structs::ShorthandTransaction {
            fn into_into_dart(self) -> crate::api::pub_structs::ShorthandTransaction {
                ...
                impl SseEncode for Thread {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>>>::sse_encode(flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(self), serializer);}
                }
                
                impl SseEncode for WalletMethod {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>>>::sse_encode(flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(self), serializer);}
                }
                ...
                impl SseEncode for RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>> {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {let (ptr, size) = self.sse_encode_raw();
                <usize>::sse_encode(ptr, serializer);
                <i32>::sse_encode(size, serializer);}
                ...
                impl SseEncode for RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>> {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {let (ptr, size) = self.sse_encode_raw();
                <usize>::sse_encode(ptr, serializer);
                <i32>::sse_encode(size, serializer);}
                ...
                impl SseEncode for crate::api::pub_structs::DartMethod {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {match self {crate::api::pub_structs::DartMethod::StorageSet(field0,field1) => { <i32>::sse_encode(0, serializer); <String>::sse_encode(field0, serializer);
<String>::sse_encode(field1, serializer);
 }
crate::api::pub_structs::DartMethod::StorageGet(field0) => { <i32>::sse_encode(1, serializer); <String>::sse_encode(field0, serializer);
 }
 _ => { unimplemented!(""); }}}
                }
                ...
                impl SseEncode for crate::api::pub_structs::KeyPress {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<i32>::sse_encode(match self {crate::api::pub_structs::KeyPress::Zero => { 0 }
 ...
 _ => { unimplemented!(""); }}, serializer);}
        ...
        for item in self { <u8>::sse_encode(item, serializer); }}
                ...
                impl SseEncode for crate::api::pub_structs::PageName {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {match self {crate::api::pub_structs::PageName::BitcoinHome => { <i32>::sse_encode(0, serializer);  }
crate::api::pub_structs::PageName::ViewTransaction(field0) => { <i32>::sse_encode(1, serializer); <String>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::Receive => { <i32>::sse_encode(2, serializer);  }
crate::api::pub_structs::PageName::Send(field0) => { <i32>::sse_encode(3, serializer); <String>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::Amount(field0,field1) => { <i32>::sse_encode(4, serializer); <String>::sse_encode(field0, serializer);
<Option<crate::api::pub_structs::KeyPress>>::sse_encode(field1, serializer);
 }
crate::api::pub_structs::PageName::Speed(field0) => { <i32>::sse_encode(5, serializer); <u64>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::Confirm(field0,field1,field2) => { <i32>::sse_encode(6, serializer); <String>::sse_encode(field0, serializer);
<u64>::sse_encode(field1, serializer);
<u64>::sse_encode(field2, serializer);
 }
crate::api::pub_structs::PageName::Success(field0) => { <i32>::sse_encode(7, serializer); <String>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::Test(field0) => { <i32>::sse_encode(8, serializer); <String>::sse_encode(field0, serializer);
 }
 _ => { unimplemented!(""); }}}
                }
                ...
                impl SseEncode for crate::api::pub_structs::Platform {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<i32>::sse_encode(match self {crate::api::pub_structs::Platform::Mac => { 0 }
...
<Option<String>>::sse_encode(self.abt_me, serializer);}
                ...
                impl SseEncode for crate::api::pub_structs::ShorthandTransaction {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<bool>::sse_encode(self.is_withdraw, serializer);
...
flutter_rust_bridge::frb_generated_boilerplate_io!();
                ...
                #[no_mangle]
                pub extern "C" fn frbgen_orange_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(ptr: *const std::ffi::c_void)  {
                    MoiArc::<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>>::increment_strong_count(ptr as _);
                }
            

                #[no_mangle]
                pub extern "C" fn frbgen_orange_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(ptr: *const std::ffi::c_void)  {
                    MoiArc::<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>>::decrement_strong_count(ptr as _);
                }
            

                #[no_mangle]
                pub extern "C" fn frbgen_orange_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(ptr: *const std::ffi::c_void)  {
                    MoiArc::<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>>::increment_strong_count(ptr as _);
                }
            

                #[no_mangle]
                pub extern "C" fn frbgen_orange_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(ptr: *const std::ffi::c_void)  {
                    MoiArc::<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>>::decrement_strong_count(ptr as _);
                }
...
flutter_rust_bridge::frb_generated_boilerplate_web!();
                ...
                #[wasm_bindgen]
                pub  fn rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(ptr: *const std::ffi::c_void)  {
                    MoiArc::<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>>::increment_strong_count(ptr as _);
                }
            

                #[wasm_bindgen]
                pub  fn rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(ptr: *const std::ffi::c_void)  {
                    MoiArc::<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Thread>>::decrement_strong_count(ptr as _);
                }
            

                #[wasm_bindgen]
                pub  fn rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(ptr: *const std::ffi::c_void)  {
                    MoiArc::<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>>::increment_strong_count(ptr as _);
                }
            

                #[wasm_bindgen]
                pub  fn rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(ptr: *const std::ffi::c_void)  {
                    MoiArc::<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletMethod>>::decrement_strong_count(ptr as _);
                }

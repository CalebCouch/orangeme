...
4 => { return crate::api::pub_structs::PageName::MyProfile; }
5 => { return crate::api::pub_structs::PageName::MessagesHome; }
6 => { return crate::api::pub_structs::PageName::Test; }
 _ => { unimplemented!(""); }}}
                }
...
return crate::api::pub_structs::WalletMethod::GetFees(var_field0, var_field1, var_field2); }
 _ => { unimplemented!(""); }}}
                }
...
11 => wire__crate__api__simple__rustStart_impl(port, ptr, rust_vec_len, data_len),
                ...
                fn pde_ffi_dispatcher_sync_impl(
                    ...
                    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
                    match func_id {
                        9 => wire__crate__api__pub_structs__platform_is_desktop_impl(ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
                }
...
crate::api::pub_structs::PageName::Speed(field0,field1) => { [1.into_dart(),
field0.into_into_dart().into_dart(),
field1.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Receive => { [2.into_dart()].into_dart() }
crate::api::pub_structs::PageName::ViewTransaction(field0) => { [3.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::MyProfile => { [4.into_dart()].into_dart() }
crate::api::pub_structs::PageName::MessagesHome => { [5.into_dart()].into_dart() }
crate::api::pub_structs::PageName::Test => { [6.into_dart()].into_dart() }
 _ => { unimplemented!(""); }}
                }
            }
...
crate::api::pub_structs::WalletMethod::GetFees(field0,field1,field2) => { [1.into_dart(),
field0.into_into_dart().into_dart(),
...
crate::api::pub_structs::PageName::Speed(field0,field1) => { <i32>::sse_encode(1, serializer); <String>::sse_encode(field0, serializer);
<u64>::sse_encode(field1, serializer);
 }
crate::api::pub_structs::PageName::Receive => { <i32>::sse_encode(2, serializer);  }
crate::api::pub_structs::PageName::ViewTransaction(field0) => { <i32>::sse_encode(3, serializer); <String>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::MyProfile => { <i32>::sse_encode(4, serializer);  }
crate::api::pub_structs::PageName::MessagesHome => { <i32>::sse_encode(5, serializer);  }
crate::api::pub_structs::PageName::Test => { <i32>::sse_encode(6, serializer);  }
 _ => { unimplemented!(""); }}}
                }
...
crate::api::pub_structs::WalletMethod::GetFees(field0,field1,field2) => { <i32>::sse_encode(1, serializer); <String>::sse_encode(field0, serializer);
<u64>::sse_encode(field1, serializer);

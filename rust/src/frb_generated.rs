...
fn wire__crate__api__custom_handler__MyCustomAsyncRuntime_default_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
            ...
            let api_path = <String>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, String>((move ||  {
                         let output_ok = crate::api::simple::clearData(api_path)?;   Ok(output_ok)
                    })())
                } })
...
let api__sc = <crate::api::pub_structs::ShorthandConversation>::sse_decode(&mut deserializer);
...
let api__kp = <crate::api::pub_structs::KeyPress>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, ()>((move ||  {
                         let output_ok = Result::<_,()>::Ok({ crate::api::pub_structs::load_structs(api__s, api__sc, api__m, api__p, api__dm, api__kp); })?;   Ok(output_ok)
                    })())
                } })
            }fn wire__crate__api__pub_structs__load_structs2_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "load_structs2", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api__pl = <crate::api::pub_structs::Platform>::sse_decode(&mut deserializer);
let api__pn = <crate::api::pub_structs::PageName>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, ()>((move ||  {
                         let output_ok = Result::<_,()>::Ok({ crate::api::pub_structs::load_structs2(api__pl, api__pn); })?;   Ok(output_ok)
                    })())
                } })
...
let api_callback = decode_DartFn_Inputs_dart_method_Output_opt_String_AnyhowException(<flutter_rust_bridge::DartOpaque>::sse_decode(&mut deserializer));deserializer.end(); move |context| async move {
            ...
            }fn wire__crate__api__utils__update_amount_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "update_amount", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_amount = <String>::sse_decode(&mut deserializer);
let api_key = <crate::api::pub_structs::KeyPress>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>((move ||  {
                         let output_ok = crate::api::utils::update_amount(api_amount, api_key)?;   Ok(output_ok)
                    })())
                } })
            }
...
return crate::api::pub_structs::DartProfile{name: var_name, did: var_did, pfp_path: var_pfpPath, abt_me: var_abtMe};}
                }
...
12 => crate::api::pub_structs::KeyPress::Backspace,
        ...
        let mut ans_ = vec![];
        for idx_ in 0..len_ { ans_.push(<crate::api::pub_structs::DartProfile>::sse_decode(deserializer)); }
        return ans_;}
                }
        ...
        return ans_;}
                ...
                impl SseDecode for crate::api::pub_structs::Message {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut var_sender = <crate::api::pub_structs::DartProfile>::sse_decode(deserializer);
...
return crate::api::pub_structs::Message{sender: var_sender, message: var_message, date: var_date, time: var_time, is_incoming: var_isIncoming};}
                }
...
8 => { let mut var_field0 = <bool>::sse_decode(deserializer);
return crate::api::pub_structs::PageName::MyProfile(var_field0); }
9 => { let mut var_field0 = <bool>::sse_decode(deserializer);
let mut var_field1 = <crate::api::pub_structs::DartProfile>::sse_decode(deserializer);
return crate::api::pub_structs::PageName::UserProfile(var_field0, var_field1); }
10 => { return crate::api::pub_structs::PageName::MessagesHome; }
11 => { return crate::api::pub_structs::PageName::ChooseRecipient; }
12 => { let mut var_field0 = <String>::sse_decode(deserializer);
let mut var_field1 = <Vec<crate::api::pub_structs::DartProfile>>::sse_decode(deserializer);
return crate::api::pub_structs::PageName::CurrentConversation(var_field0, var_field1); }
...
15 => { return crate::api::pub_structs::PageName::Scan; }
 _ => { unimplemented!(""); }}}
                }
...
return (var_field0, var_field1, var_field2);}
                ...
                impl SseDecode for crate::api::pub_structs::ShorthandConversation {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut var_roomName = <String>::sse_decode(deserializer);
...
return crate::api::pub_structs::ShorthandConversation{room_name: var_roomName, photo: var_photo, subtext: var_subtext, is_group: var_isGroup, room_id: var_roomId};}
                }
...
return crate::api::pub_structs::ShorthandTransaction{is_withdraw: var_isWithdraw, datetime: var_datetime, amount: var_amount, txid: var_txid};}
                ...
                fn pde_ffi_dispatcher_primary_impl(
                    ...
                    match func_id {
                        1 => wire__crate__api__custom_handler__MyCustomAsyncRuntime_default_impl(port, ptr, rust_vec_len, data_len),
...
self.abt_me.into_into_dart().into_dart()
            ...
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::pub_structs::DartProfile {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::DartProfile> for crate::api::pub_structs::DartProfile {
...
self.is_incoming.into_into_dart().into_dart()
            ...
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::pub_structs::Message {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::Message> for crate::api::pub_structs::Message {
...
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Amount(field0) => { [4.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
...
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::MyProfile(field0) => { [8.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::UserProfile(field0,field1) => { [9.into_dart(),
field0.into_into_dart().into_dart(),
field1.into_into_dart().into_dart()].into_dart() }
...
crate::api::pub_structs::PageName::CurrentConversation(field0,field1) => { [12.into_dart(),
field0.into_into_dart().into_dart(),
field1.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::ConversationInfo(field0) => { [13.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::pub_structs::PageName::Test(field0) => { [14.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
...
self.room_id.into_into_dart().into_dart()
            ...
            impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::pub_structs::ShorthandConversation {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::pub_structs::ShorthandConversation> for crate::api::pub_structs::ShorthandConversation {
...
crate::api::pub_structs::KeyPress::Backspace => { 12 }
 _ => { unimplemented!(""); }}, serializer);}
        ...
        for item in self { <crate::api::pub_structs::DartProfile>::sse_encode(item, serializer); }}
                }
        ...
        for item in self { <u8>::sse_encode(item, serializer); }}
                ...
                impl SseEncode for crate::api::pub_structs::Message {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<crate::api::pub_structs::DartProfile>::sse_encode(self.sender, serializer);
...
crate::api::pub_structs::PageName::Amount(field0) => { <i32>::sse_encode(4, serializer); <String>::sse_encode(field0, serializer);
 }
...
crate::api::pub_structs::PageName::MyProfile(field0) => { <i32>::sse_encode(8, serializer); <bool>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::UserProfile(field0,field1) => { <i32>::sse_encode(9, serializer); <bool>::sse_encode(field0, serializer);
<crate::api::pub_structs::DartProfile>::sse_encode(field1, serializer);
 }
crate::api::pub_structs::PageName::MessagesHome => { <i32>::sse_encode(10, serializer);  }
crate::api::pub_structs::PageName::ChooseRecipient => { <i32>::sse_encode(11, serializer);  }
crate::api::pub_structs::PageName::CurrentConversation(field0,field1) => { <i32>::sse_encode(12, serializer); <String>::sse_encode(field0, serializer);
<Vec<crate::api::pub_structs::DartProfile>>::sse_encode(field1, serializer);
 }
crate::api::pub_structs::PageName::ConversationInfo(field0) => { <i32>::sse_encode(13, serializer); <String>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::Test(field0) => { <i32>::sse_encode(14, serializer); <String>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::Scan => { <i32>::sse_encode(15, serializer);  }
 _ => { unimplemented!(""); }}}
                }
...
<u8>::sse_encode(self.2, serializer);}
                ...
                impl SseEncode for crate::api::pub_structs::ShorthandConversation {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<String>::sse_encode(self.room_name, serializer);

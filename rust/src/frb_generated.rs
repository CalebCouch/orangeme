...
let api_page = <crate::api::pub_structs::PageName>::sse_decode(&mut deserializer);deserializer.end(); move |context| async move {
            ...
            let api_thread = <crate::api::pub_structs::Thread>::sse_decode(&mut deserializer);deserializer.end(); move |context| async move {
                    transform_result_sse::<_, ()>((move || async move {
                         let output_ok = Result::<_,()>::Ok(crate::api::simple::rustCall(api_thread).await)?;   Ok(output_ok)
                    })().await)
                } })
...
3 => { return crate::api::pub_structs::PageName::Test; }
 _ => { unimplemented!(""); }}}
                }
...
return crate::api::pub_structs::Thread::Wallet(var_field0); }
 _ => { unimplemented!(""); }}}
                ...
                impl SseDecode for crate::api::pub_structs::WalletMethod {
                    ...
                    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {let mut inner = <i32>::sse_decode(deserializer);
        return match inner {
            0 => crate::api::pub_structs::WalletMethod::GetNewAddress,
            _ => unreachable!("Invalid variant for WalletMethod: {}", inner),
        };}
                }
...
crate::api::pub_structs::PageName::ViewTransaction(field0) => { [2.into_dart(),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
            impl flutter_rust_bridge::IntoDart for crate::api::pub_structs::WalletMethod {
                fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
                    match self {
                    Self::GetNewAddress => 0.into_dart(),
                    _ => unreachable!(),
                }
                }
            }
...
crate::api::pub_structs::PageName::ViewTransaction(field0) => { <i32>::sse_encode(2, serializer); <String>::sse_encode(field0, serializer);
 }
crate::api::pub_structs::PageName::Test => { <i32>::sse_encode(3, serializer);  }
 _ => { unimplemented!(""); }}}
                }
...
crate::api::pub_structs::Platform::Fuchsia => { 5 }
 ...
 _ => { unimplemented!(""); }}}
                ...
                impl SseEncode for crate::api::pub_structs::WalletMethod {
                    // Codec=Sse (Serialization based), see doc to use other codecs
                    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {<i32>::sse_encode(match self {crate::api::pub_structs::WalletMethod::GetNewAddress => { 0 }
 _ => { unimplemented!(""); }}, serializer);}
                }

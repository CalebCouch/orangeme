...
import type { DwnMessage, DwnMessageInstance, DwnMessageParams, DwnResponse, ProcessDwnRequest, SendDwnRequest } from './types/dwn.js';
...
export declare class AgentDwnApi {
     ...
     */
    get node(): Dwn;
    static createDwn({ dataPath, dataStore, didResolver, eventLog, eventStream, messageStore, tenantGate }: DwnApiCreateDwnParams): Promise<Dwn>;
     ...
     * - processMessage()
     */
    createMessage<T extends DwnInterface>({ author, messageParams, messageType }: {
        author: string;
        messageType: T;

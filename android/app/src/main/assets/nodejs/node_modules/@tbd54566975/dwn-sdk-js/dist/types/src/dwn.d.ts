...
export declare class Dwn {
    ...
    processMessage(tenant: string, rawMessage: EventsQueryMessage): Promise<EventsQueryReply>;
    processMessage(tenant: string, rawMessage: EventsSubscribeMessage, options?: EventsSubscribeMessageOptions): Promise<EventsSubscribeReply>;

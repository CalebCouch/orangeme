...
import type { EncryptionProperty, InternalRecordsWriteMessage, RecordsWriteDescriptor, RecordsWriteMessage, RecordsWriteSignaturePayload, RecordsWriteTags } from '../types/records-types.js';
...
export declare class RecordsWrite implements MessageInterface<RecordsWriteMessage> {
     ...
     * NOTE: requires the `RecordsWrite` to already have the author's signature.
     */
    signAsOwnerDelegate(signer: Signer, delegatedGrant: RecordsWriteMessage): Promise<void>;
    /**

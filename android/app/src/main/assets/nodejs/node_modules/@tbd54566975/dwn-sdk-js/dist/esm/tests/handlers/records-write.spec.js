        ...
        describe('functional tests', () => {
            ...
            describe('grant based writes', () => {
                it('allows external parties to write a record using a grant with unrestricted RecordsWrite scope', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const grantRecordsWriteReply = yield dwn.processMessage(alice.did, permissionGrant.recordsWrite.message, { dataStream: grantDataStream });
                    ...
                    const recordsWriteReply = yield dwn.processMessage(alice.did, protocolRecordsWrite.message, { dataStream: protocolRecordsWrite.dataStream });
                    expect(recordsWriteReply.status.code).to.equal(202);
                    ...
                    const recordsWriteReply2 = yield dwn.processMessage(alice.did, nonProtocolRecordsWrite.message, { dataStream: nonProtocolRecordsWrite.dataStream });

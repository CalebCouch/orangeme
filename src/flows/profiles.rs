...
pub fn my_profile(ctx: &mut Context) -> Page {
...
pub fn user_profile(ctx: &mut Context) -> Page {
    let new_message = Button::primary(ctx, "New Message", |_ctx: &mut Context| println!("New..."));
    let bumper = Bumper::new(vec![Box::new(new_message)]);
...
pub fn block_user(ctx: &mut Context) -> Page {
    let new_message = Button::primary(ctx, "New Message", |_ctx: &mut Context| println!("New..."));
    let bumper = Bumper::new(vec![Box::new(new_message)]);
...
pub fn user_blocked(ctx: &mut Context) -> Page {
    let new_message = Button::primary(ctx, "New Message", |_ctx: &mut Context| println!("New..."));
    let bumper = Bumper::new(vec![Box::new(new_message)]);

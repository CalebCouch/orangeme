...
abstract class QrFrameShape extends QrElementShape {
  ...
  static QrFrameShapeCircle circle(
          {double widthFraction = 1, double radiusFraction = 1}) =>
      QrFrameShapeCircle(
          widthFraction: widthFraction, radiusFraction: radiusFraction);
...
class QrFrameShapeDefault extends QrFrameShape {
  ...
  Path createPath(Offset offset, double size, Neighbors? neighbors) => Path()
    ...
    ..addRect(Rect.fromLTWH(offset.dx + size / 7, offset.dy + size / 7,
        size * 5 / 7, size * 5 / 7));
...
class QrFrameShapeCircle extends QrFrameShape {
  ...
  const QrFrameShapeCircle({this.widthFraction = 1, this.radiusFraction = 1});
  ...
  Path createPath(Offset offset, double size, Neighbors? neighbors) {
    ...
    return Path()
      ...
      ..addOval(Rect.fromLTWH(
          offset.dx + offset2, offset.dy + offset2, realSize, realSize))
      ..addOval(Rect.fromLTWH(

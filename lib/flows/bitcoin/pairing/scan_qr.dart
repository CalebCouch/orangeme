...
import 'package:orange/flows/bitcoin/pairing/success.dart';
...
class ScanQRState extends State<ScanQR> {
          ...
          Content(
            content: Column(
              ...
              children: [
                ...
                const CustomText(
                  text:
                      'Scan the QR code displayed on your laptop or desktop computer',
  ...
  _onQRViewCreated(GlobalState globalState, QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      switchPageTo(context, Success(globalState));
    });
  }
}

...
class SpendingReceive extends StatefulWidget {
  const SpendingReceive({super.key});

  @override
  SpendingReceiveState createState() => SpendingReceiveState();
}

//hardcoded placecholder address
String _address = "bc1qxy2k23432f2493p83kkfjhx0wlh";

class SpendingReceiveState extends State<SpendingReceive> {
  @override
  void initState() {
    super.initState();
  }

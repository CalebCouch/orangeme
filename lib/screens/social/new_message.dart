...
import 'package:orange/screens/social/message_group.dart';
...
//TODO revise appbar font size to heading3
//TODO allow group messages
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          //   runSpacing: 8,
          //   children: recipients
          //       .map((recipient) => ButtonSecondaryMD(
          //             label: recipient,
          //             icon: "clear",
          //             onTap: () => removeRecipient(recipient),
          //           ))
          //       .toList(),
          // ),
          Expanded(

...
case 2: return PageName_Test(dco_decode_String(raw[1]),);
...
return ShorthandTransaction(isWithdraw: var_isWithdraw, date: var_date, time: var_time, amount: var_amount, txid: var_txid); }
...
switch (self) { case PageName_BitcoinHome(): sse_encode_i_32(0, serializer); case PageName_Receive(): sse_encode_i_32(1, serializer); case PageName_Test(field0: final field0): sse_encode_i_32(2, serializer); sse_encode_String(field0, serializer);

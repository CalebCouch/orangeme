...
Future<void> crateApiPubStructsLoadStructs({required ShorthandTransaction s , required Profile p , required DartMethod dm , required KeyPress kp , required Platform pl , required PageName pn , required WalletMethod wm , required Thread t });
...
Future<String> crateApiSimpleRustStart({required String path , required Platform platform , required FutureOr<String?> Function(DartMethod) callback });
...
RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_Thread;

RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_Thread;

CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_ThreadPtr;

RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_WalletMethod;

RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_WalletMethod;

CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_WalletMethodPtr;
...
@override Future<void> crateApiPubStructsLoadStructs({required ShorthandTransaction s , required Profile p , required DartMethod dm , required KeyPress kp , required Platform pl , required PageName pn , required WalletMethod wm , required Thread t })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(wm, serializer);
sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(t, serializer);
...
@override Future<String> crateApiSimpleRustCall({required Thread thread })  { return handler.executeNormal(NormalTask(
            ...
            final serializer = SseSerializer(generalizedFrbRustBinding);sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(thread, serializer);
...
@override Future<String> crateApiSimpleRustStart({required String path , required Platform platform , required FutureOr<String?> Function(DartMethod) callback })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              
            final serializer = SseSerializer(generalizedFrbRustBinding);sse_encode_String(path, serializer);
sse_encode_platform(platform, serializer);
sse_encode_DartFn_Inputs_dart_method_Output_opt_String_AnyhowException(callback, serializer);
        ...
        TaskConstMeta get kCrateApiSimpleRustStartConstMeta => const TaskConstMeta(
            ...
            Future<void> Function(int, dynamic)
                encode_DartFn_Inputs_dart_method_Output_opt_String_AnyhowException(FutureOr<String?> Function(DartMethod) raw) {
...
RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_Thread => wire.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread;

RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_Thread => wire.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread;

RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_WalletMethod => wire.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod;

RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_WalletMethod => wire.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod;
...
@protected Thread dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
return ThreadImpl.frbInternalDcoDecode(raw as List<dynamic>); }

@protected WalletMethod dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
return WalletMethodImpl.frbInternalDcoDecode(raw as List<dynamic>); }

@protected FutureOr<String?> Function(DartMethod) dco_decode_DartFn_Inputs_dart_method_Output_opt_String_AnyhowException(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
@protected Thread dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
return ThreadImpl.frbInternalDcoDecode(raw as List<dynamic>); }

@protected WalletMethod dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
return WalletMethodImpl.frbInternalDcoDecode(raw as List<dynamic>); }
...
@protected DartMethod dco_decode_box_autoadd_dart_method(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
return dco_decode_dart_method(raw); }

@protected KeyPress dco_decode_box_autoadd_key_press(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
@protected DartMethod dco_decode_dart_method(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
switch (raw[0]) {
                case 0: return DartMethod_StorageSet(dco_decode_String(raw[1]),dco_decode_String(raw[2]),);
case 1: return DartMethod_StorageGet(dco_decode_String(raw[1]),);
...
@protected KeyPress? dco_decode_opt_box_autoadd_key_press(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
switch (raw[0]) {
                case 0: return const PageName_BitcoinHome();
case 1: return PageName_ViewTransaction(dco_decode_String(raw[1]),);
case 2: return const PageName_Receive();
case 3: return PageName_Send(dco_decode_String(raw[1]),);
case 4: return PageName_Amount(dco_decode_String(raw[1]),dco_decode_opt_box_autoadd_key_press(raw[2]),);
case 5: return PageName_Speed(dco_decode_u_64(raw[1]),);
case 6: return PageName_Confirm(dco_decode_String(raw[1]),dco_decode_u_64(raw[2]),dco_decode_u_64(raw[3]),);
case 7: return PageName_Success(dco_decode_String(raw[1]),);
case 8: return PageName_Test(dco_decode_String(raw[1]),);
                default: throw Exception("unreachable");
            } }
...
@protected Thread sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
return ThreadImpl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer)); }

@protected WalletMethod sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
return WalletMethodImpl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer)); }
...
@protected Thread sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
return ThreadImpl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer)); }

@protected WalletMethod sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
return WalletMethodImpl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer)); }
...
@protected DartMethod sse_decode_box_autoadd_dart_method(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
return (sse_decode_dart_method(deserializer)); }

@protected KeyPress sse_decode_box_autoadd_key_press(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected DartMethod sse_decode_dart_method(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs

            var tag_ = sse_decode_i_32(deserializer);
            switch (tag_) { case 0: var var_field0 = sse_decode_String(deserializer);
var var_field1 = sse_decode_String(deserializer);
return DartMethod_StorageSet(var_field0, var_field1);case 1: var var_field0 = sse_decode_String(deserializer);
return DartMethod_StorageGet(var_field0); default: throw UnimplementedError(''); }
             }
...
@protected KeyPress? sse_decode_opt_box_autoadd_key_press(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected PageName sse_decode_page_name(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
            ...
            var tag_ = sse_decode_i_32(deserializer);
            switch (tag_) { case 0: return const PageName_BitcoinHome();case 1: var var_field0 = sse_decode_String(deserializer);
return PageName_ViewTransaction(var_field0);case 2: return const PageName_Receive();case 3: var var_field0 = sse_decode_String(deserializer);
return PageName_Send(var_field0);case 4: var var_field0 = sse_decode_String(deserializer);
var var_field1 = sse_decode_opt_box_autoadd_key_press(deserializer);
return PageName_Amount(var_field0, var_field1);case 5: var var_field0 = sse_decode_u_64(deserializer);
return PageName_Speed(var_field0);case 6: var var_field0 = sse_decode_String(deserializer);
var var_field1 = sse_decode_u_64(deserializer);
var var_field2 = sse_decode_u_64(deserializer);
return PageName_Confirm(var_field0, var_field1, var_field2);case 7: var var_field0 = sse_decode_String(deserializer);
return PageName_Success(var_field0);case 8: var var_field0 = sse_decode_String(deserializer);
...
@protected void sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(Thread self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_usize((self as ThreadImpl).frbInternalSseEncode(move: true), serializer); }

@protected void sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(WalletMethod self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_usize((self as WalletMethodImpl).frbInternalSseEncode(move: true), serializer); }

@protected void sse_encode_DartFn_Inputs_dart_method_Output_opt_String_AnyhowException(FutureOr<String?> Function(DartMethod) self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_DartOpaque(encode_DartFn_Inputs_dart_method_Output_opt_String_AnyhowException(self), serializer); }
...
@protected void sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerThread(Thread self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_usize((self as ThreadImpl).frbInternalSseEncode(move: null), serializer); }

@protected void sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletMethod(WalletMethod self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_usize((self as WalletMethodImpl).frbInternalSseEncode(move: null), serializer); }
...
@protected void sse_encode_box_autoadd_dart_method(DartMethod self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_dart_method(self, serializer); }

@protected void sse_encode_box_autoadd_key_press(KeyPress self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected void sse_encode_dart_method(DartMethod self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
switch (self) { case DartMethod_StorageSet(field0: final field0,field1: final field1): sse_encode_i_32(0, serializer); sse_encode_String(field0, serializer);
sse_encode_String(field1, serializer);
case DartMethod_StorageGet(field0: final field0): sse_encode_i_32(1, serializer); sse_encode_String(field0, serializer);
...
@protected void sse_encode_opt_box_autoadd_key_press(KeyPress? self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
switch (self) { case PageName_BitcoinHome(): sse_encode_i_32(0, serializer); case PageName_ViewTransaction(field0: final field0): sse_encode_i_32(1, serializer); sse_encode_String(field0, serializer);
case PageName_Receive(): sse_encode_i_32(2, serializer); case PageName_Send(field0: final field0): sse_encode_i_32(3, serializer); sse_encode_String(field0, serializer);
case PageName_Amount(field0: final field0,field1: final field1): sse_encode_i_32(4, serializer); sse_encode_String(field0, serializer);
sse_encode_opt_box_autoadd_key_press(field1, serializer);
case PageName_Speed(field0: final field0): sse_encode_i_32(5, serializer); sse_encode_u_64(field0, serializer);
case PageName_Confirm(field0: final field0,field1: final field1,field2: final field2): sse_encode_i_32(6, serializer); sse_encode_String(field0, serializer);
sse_encode_u_64(field1, serializer);
sse_encode_u_64(field2, serializer);
case PageName_Success(field0: final field0): sse_encode_i_32(7, serializer); sse_encode_String(field0, serializer);
case PageName_Test(field0: final field0): sse_encode_i_32(8, serializer); sse_encode_String(field0, serializer);
 default: throw UnimplementedError(''); } }
...
serializer.buffer.putBigUint64(self); }
            ...
            @sealed class ThreadImpl extends RustOpaque implements Thread {
                // Not to be used by end users
                ThreadImpl.frbInternalDcoDecode(List<dynamic> wire):
                    super.frbInternalDcoDecode(wire, _kStaticData);

                // Not to be used by end users
                ThreadImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative):
                    super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

                static final _kStaticData = RustArcStaticData(
                    rustArcIncrementStrongCount: RustLib.instance.api.rust_arc_increment_strong_count_Thread,
                    rustArcDecrementStrongCount: RustLib.instance.api.rust_arc_decrement_strong_count_Thread,
                    rustArcDecrementStrongCountPtr: RustLib.instance.api.rust_arc_decrement_strong_count_ThreadPtr,
                );

                
            }
            @sealed class WalletMethodImpl extends RustOpaque implements WalletMethod {
                // Not to be used by end users
                WalletMethodImpl.frbInternalDcoDecode(List<dynamic> wire):
                    super.frbInternalDcoDecode(wire, _kStaticData);

                // Not to be used by end users
                WalletMethodImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative):
                    super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

                static final _kStaticData = RustArcStaticData(
                    rustArcIncrementStrongCount: RustLib.instance.api.rust_arc_increment_strong_count_WalletMethod,
                    rustArcDecrementStrongCount: RustLib.instance.api.rust_arc_decrement_strong_count_WalletMethod,
                    rustArcDecrementStrongCountPtr: RustLib.instance.api.rust_arc_decrement_strong_count_WalletMethodPtr,
                );

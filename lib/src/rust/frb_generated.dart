...
case 1: return PageName_Speed(dco_decode_String(raw[1]),dco_decode_u_64(raw[2]),);
case 2: return const PageName_Receive();
case 3: return PageName_ViewTransaction(dco_decode_String(raw[1]),);
case 4: return const PageName_MyProfile();
case 5: return const PageName_MessagesHome();
case 6: return const PageName_Test();
...
switch (raw[0]) {
                case 0: return const WalletMethod_GetNewAddress();
case 1: return WalletMethod_GetFees(dco_decode_String(raw[1]),dco_decode_u_64(raw[2]),dco_decode_f_64(raw[3]),);
                default: throw Exception("unreachable");
            } }
...
return PageName_Speed(var_field0, var_field1);case 2: return const PageName_Receive();case 3: var var_field0 = sse_decode_String(deserializer);
return PageName_ViewTransaction(var_field0);case 4: return const PageName_MyProfile();case 5: return const PageName_MessagesHome();case 6: return const PageName_Test(); default: throw UnimplementedError(''); }
             }
...
@protected WalletMethod sse_decode_wallet_method(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
            ...
            var tag_ = sse_decode_i_32(deserializer);
            switch (tag_) { case 0: return const WalletMethod_GetNewAddress();case 1: var var_field0 = sse_decode_String(deserializer);
var var_field1 = sse_decode_u_64(deserializer);
...
case PageName_MyProfile(): sse_encode_i_32(4, serializer); case PageName_MessagesHome(): sse_encode_i_32(5, serializer); case PageName_Test(): sse_encode_i_32(6, serializer);  default: throw UnimplementedError(''); } }
